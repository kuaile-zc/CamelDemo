...
public interface QueryServiceInter {
	...
	public String queryCarInfomation(
			@WebParam(name = "carParam", targetNamespace = "") String carParam);
	...
	@WebResult(name = "return", targetNamespace = "")
	public String queryPersonnelInformation(
			@WebParam(name = "peopleParam", targetNamespace = "") String peopleParam);
}
